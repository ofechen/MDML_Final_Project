...
```{r}
#refit a logistic regression model on train
...
regfit.fwd = regsubsets(bottom_hint ~ tutor_mode + prev_total_correct +
                          prev_percent_correct + prev_problem_requested_hint + 
                          prev_percent_problem_requested_hint + prev_avg_response_time + 
...
##Drop the predictors and refit the logistic model 
```{r}
# refit the model by dropping the following features based on the results from forward stepwise selection by including 6 features
