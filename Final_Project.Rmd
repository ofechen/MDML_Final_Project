...
(e) scaffolding means whether sutdent asks for the problem to be broken into steps
...
lg_hint <- glm(first_action ~ tutor_mode + answer_type + prev_total_correct + 
                 ...
                 prev_total_bottom_hint + prev_percent_bottom_out + prev_avg_attempt_count, 
...
re_lg_hint <- glm(first_action ~ tutor_mode + answer_type + prev_total_correct + 
                 prev_percent_problem_requested_hint + prev_avg_response_time + 
                 prev_percent_bottom_out + prev_avg_attempt_count, 
               data=train, family="binomial")
...
rf_hint <- randomForest(first_action ~ tutor_mode + answer_type + prev_total_correct + 
                 prev_percent_problem_requested_hint + prev_avg_response_time + 
                 prev_percent_bottom_out + prev_avg_attempt_count, data=train, ntree=200, 
                 na.action=na.omit)
